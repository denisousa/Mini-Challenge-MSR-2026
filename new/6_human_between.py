...
if df_human_clones is not None and not df_human_clones.empty:
    ...
    change_output_path = os.path.join(results_04_path, "human_clones_change_patterns.csv")
    ...
    evolution_output_path = os.path.join(results_04_path, "human_clones_evolution_patterns.csv")
